...
**Barra superior.** Fondo `--azul-profundo`, alto 64 px. Logo horizontal en blanco a la izquierda con 24 px de margen. Navegación centrada o a la derecha; la pestaña activa lleva subrayado de 3 px en `--cian`.
